...
SONIOX_STT_PRECONNECT = env_bool("SONIOX_STT_PRECONNECT", False)
...
SONIOX_TTS_FIRST_SEGMENT_MS = env_int("SONIOX_TTS_FIRST_SEGMENT_MS", 450)
SONIOX_TTS_SEGMENT_MS = env_int("SONIOX_TTS_SEGMENT_MS", 1100)
SONIOX_TTS_MIN_SEGMENT_MS = env_int("SONIOX_TTS_MIN_SEGMENT_MS", 450)
SONIOX_TTS_MAX_SEGMENT_MS = env_int("SONIOX_TTS_MAX_SEGMENT_MS", 1100)
...
GEMINI_MAX_OUTPUT_TOKENS = env_int("GEMINI_MAX_OUTPUT_TOKENS", 300)
...
ANSWER_RACE_TIMEOUT_MS = env_int("ANSWER_RACE_TIMEOUT_MS", 450)
