...
//#region node_modules/@ricky0123/vad-web/dist/asset-path.js
var require_asset_path = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.baseAssetPath = void 0;
	var currentScript = typeof window !== "undefined" && typeof window.document !== "undefined" ? window.document.currentScript : null;
	var basePath = "/";
	if (currentScript) basePath = currentScript.src.replace(/#.*$/, "").replace(/\?.*$/, "").replace(/\/[^/]+$/, "/");
	exports.baseAssetPath = basePath;
}));
//#endregion
//#region node_modules/@ricky0123/vad-web/dist/default-model-fetcher.js
var require_default_model_fetcher = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
...
//#endregion
//#region node_modules/@ricky0123/vad-web/dist/logging.js
...
//#endregion
//#region node_modules/@ricky0123/vad-web/dist/messages.js
...
//#endregion
//#region node_modules/@ricky0123/vad-web/dist/frame-processor.js
var require_frame_processor = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	...
	exports.defaultFrameProcessorOptions = {
		positiveSpeechThreshold: .3,
		negativeSpeechThreshold: .25,
		preSpeechPadMs: 800,
		redemptionMs: 1400,
		minSpeechMs: 400,
	...
	function validateOptions(options) {
		if (options.positiveSpeechThreshold < 0 || options.positiveSpeechThreshold > 1) logging_1.log.error("positiveSpeechThreshold should be a number between 0 and 1");
		if (options.negativeSpeechThreshold < 0 || options.negativeSpeechThreshold > options.positiveSpeechThreshold) logging_1.log.error("negativeSpeechThreshold should be between 0 and positiveSpeechThreshold");
		if (options.preSpeechPadMs < 0) logging_1.log.error("preSpeechPadMs should be positive");
		if (options.redemptionMs < 0) logging_1.log.error("redemptionMs should be positive");
		if (options.minSpeechMs < 0) logging_1.log.error("minSpeechMs should be positive");
	}
	...
	var FrameProcessor = class {
		constructor(modelProcessFunc, modelResetFunc, options, msPerFrame) {
			...
			this.pause = (handleEvent) => {
				this.active = false;
				if (this.options.submitUserSpeechOnPause) this.endSegment(handleEvent);
				else this.reset();
			};
			this.resume = () => {
				this.active = true;
			...
			this.endSegment = (handleEvent) => {
				...
				this.reset();
				if (speaking) if (audioBuffer.reduce((acc, item) => {
					return item.isSpeech ? acc + 1 : acc;
				}, 0) >= this.minSpeechFrames) {
					const audio = concatArrays(audioBuffer.map((item) => item.frame));
					handleEvent({
						msg: messages_1.Message.SpeechEnd,
						audio
					});
				} else handleEvent({ msg: messages_1.Message.VADMisfire });
				return {};
			};
			this.process = async (frame, handleEvent) => {
				...
				handleEvent({
					probs,
					msg: messages_1.Message.FrameProcessed,
					frame
				});
				...
				if (probs.isSpeech < this.options.negativeSpeechThreshold && this.speaking && ++this.redemptionCounter >= this.redemptionFrames) {
					...
					const audioBuffer = this.audioBuffer;
					this.audioBuffer = [];
					if (audioBuffer.reduce((acc, item) => {
						return item.isSpeech ? acc + 1 : acc;
					}, 0) >= this.minSpeechFrames) {
						const audio = concatArrays(audioBuffer.map((item) => item.frame));
						handleEvent({
				...
				if (!this.speaking) {
					while (this.audioBuffer.length > this.preSpeechPadFrames) this.audioBuffer.shift();
					this.speechFrameCount = 0;
				}
			};
			this.audioBuffer = [];
...
//#endregion
//#region node_modules/onnxruntime-web/dist/ort.min.js
/*!
* ONNX Runtime Web v1.26.0
* Copyright (c) Microsoft Corporation. All rights reserved.
* Licensed under the MIT License.
*/
var require_ort_min = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var ort = (() => {
		...
		var rt = (e, t) => {
			for (var n in t) $n(e, n, {
				get: t[n],
				enumerable: !0
			});
		}, Gu = (e, t, n, r) => {
			if (t && typeof t == "object" || typeof t == "function") for (let o of Lu(t)) !Wu.call(e, o) && o !== n && $n(e, o, {
				get: () => t[o],
				enumerable: !(r = Nu(t, o)) || r.enumerable
			});
			return e;
		};
		var ct = (e) => Gu($n({}, "__esModule", { value: !0 }), e);
		var Tt, Ze, Ge, Hu, br, xn = k(() => {
			"use strict";
			Tt = /* @__PURE__ */ new Map(), Ze = [], Ge = (e, t, n) => {
				if (t && typeof t.init == "function" && typeof t.createInferenceSessionHandler == "function") {
					let r = Tt.get(e);
					if (r === void 0) Tt.set(e, {
						backend: t,
						priority: n
					});
					else {
					...
					if (n >= 0) {
						let o = Ze.indexOf(e);
						o !== -1 && Ze.splice(o, 1);
						for (let i = 0; i < Ze.length; i++) if (Tt.get(Ze[i]).priority <= n) {
							Ze.splice(i, 0, e);
							return;
						}
						Ze.push(e);
		...
		var vr, ce, Sn = k(() => {
			...
			Object.defineProperty(ce, "logLevel", { enumerable: !0 });
		});
		var te, xr = k(() => {
			"use strict";
			Sn();
			...
			Sr = (e, t) => {
				...
				if (r != null) {
					...
					a === void 0 || a.mean === void 0 ? u = [
						...
						a.mean[2],
						0
					], a.mean[3] !== void 0 && (u[3] = a.mean[3])), a === void 0 || a.bias === void 0 ? d = [
						0,
						0,
						0,
						0
					] : typeof a.bias == "number" ? d = [
						a.bias,
						a.bias,
						a.bias,
						a.bias
				...
				if (n != null) {
					...
					u === void 0 || u.mean === void 0 ? d = [
						...
						u.mean[2],
						255
					], u.mean[3] !== void 0 && (d[3] = u.mean[3])), u === void 0 || u.bias === void 0 ? l = [
						0,
						0,
						0,
						0
					] : typeof u.bias == "number" ? l = [
						u.bias,
						u.bias,
						u.bias,
						u.bias
		...
		var Tn, Cr, Ar, Er, kr, Pr, zr = k(() => {
			...
			Tn = (e, t) => {
				...
				return u === "RGBA" ? new fe("float32", l, [
					1,
					4,
					n,
					r
		...
		var Mr, Ur, Rr = k(() => {
			...
			Mr = (e) => {
				...
				switch (e.location) {
					case "cpu": return new fe(e.type, e.data, t);
					case "cpu-pinned": return new fe({
						location: "cpu-pinned",
						data: e.data,
						type: e.type,
						dims: t
					});
					case "texture": return new fe({
						location: "texture",
						texture: e.texture,
						type: e.type,
						dims: t
					});
					case "gpu-buffer": return new fe({
						location: "gpu-buffer",
						gpuBuffer: e.gpuBuffer,
						type: e.type,
						dims: t
					});
					case "ml-tensor": return new fe({
						location: "ml-tensor",
						mlTensor: e.mlTensor,
						type: e.type,
						dims: t
				...
				async run(t, n, r) {
					...
					if (typeof n == "object") {
						...
						if (Array.isArray(n)) {
							...
							let d = !1, l = Object.getOwnPropertyNames(n);
							for (let c of this.outputNames) if (l.indexOf(c) !== -1) {
								let p = n[c];
								(p === null || p instanceof xe) && (d = !0, s = !1, o[c] = p);
							}
							if (d) {
								if (typeof r == "object" && r !== null) i = r;
								else if (typeof r < "u") throw new TypeError("'options' must be an object.");
		...
		var qu, Ku, $e, Rt, kn, ju, Zu, eo, Qu, Yr, to, Jr, no, Et = k(() => {
			"use strict";
			At();
			qu = typeof location > "u" ? void 0 : location.origin, Ku = () => {
				return typeof document < "u" ? document.currentScript?.src : typeof self < "u" ? self.location?.href : void 0;
			}, $e = Ku(), Rt = () => {
		...
		var Pn, zn, Vt, ro, Xu, Yu, Ju, kt, ne, He = k(() => {
			...
			zn = !1, Vt = !1, ro = !1, Xu = () => {
				...
				let o = e.wasmPaths, i = typeof o == "string" ? o : void 0, s = o?.mjs, a = s?.href ?? s, u = o?.wasm, d = u?.href ?? u, l = e.wasmBinary, [c, p] = await no(a, i, n > 1, !!l || !!d), f = !1, m = [];
				if (t > 0 && m.push(new Promise((h) => {
					...
					p(y).then((g) => {
						Vt = !1, zn = !0, Pn = g, h(), c && URL.revokeObjectURL(c);
					}, (g) => {
						Vt = !1, ro = !0, _(g);
					});
		...
		var oo, io = k(() => {
			...
			oo = (e) => {
				...
				try {
					...
					let i = 0;
					return e?.tag !== void 0 && (i = ve(e.tag, r)), n = t._OrtCreateRunOptions(o.logSeverityLevel, o.logVerbosityLevel, !!o.terminate, i), n === 0 && Y("Can't create run options."), e?.extra !== void 0 && ht(e.extra, "", /* @__PURE__ */ new WeakSet(), (s, a) => {
		...
		var ed, td, nd, ot, rd, so, ao = k(() => {
			...
			ed = (e) => {
				...
				try {
					...
					return o.extra !== void 0 && ht(o.extra, "", /* @__PURE__ */ new WeakSet(), (c, p) => {
						ot(n, c, p, r);
					}), [n, r];
				} catch (i) {
		...
		var Fe, ke, qe, it, gt, Lt, Wt, Bn, N = k(() => {
			...
			Fe = (e) => {
				...
				let n = [
					...
					.5,
					.5
				][e], r = typeof t == "number" ? t : t.reduce((o, i) => o * i, 1);
		...
		var od, id, uo, lo, Gt, sd, Z, Pe = k(() => {
			...
			od = [
				...
				let n = gt(e);
				n >= gt(uo) && id(n, typeof t == "function" ? t() : t);
			}, Z = (...e) => {
				lo && sd(...e);
			};
		});
		var On, ze, x, Ye, Ht, co, po, H = k(() => {
			...
			On = class {
				...
				static isValidBroadcast(t, n) {
					...
					if (r > o) return !1;
					for (let i = 1; i <= r; i++) if (t[r - i] !== 1 && t[r - i] !== n[o - i]) return !1;
					return !0;
				}
			}, x = class e {
				static size(t) {
				...
				static adjustPadAndReturnShape(t, n, r, o, i, s, a, u) {
					...
					if (u && u !== "NOTSET") switch (u) {
						case "VALID": return i[s] = 0, i[a] = 0, Math.floor((t - d) / n + 1);
						case "SAME_LOWER":
						case "SAME_UPPER":
		...
		var fo, Rn, ho, ad, mo, ud, go, qt, Kt, Un, yo, bo = k(() => {
			...
			fo = new Map([
				...
				async ensureTensor(t, n, r, o) {
					...
					return this.wrapper = await this.tensorManager.getCachedTensor(t, n, r, u, !0, !0, a), o && this.activeUpload && (this.wrapper.write(this.activeUpload), this.activeUpload = void 0), this.wrapper.tensor;
				}
				upload(t) {
					let n = t;
					if (this.wrapper) {
						if (this.wrapper.fallbackType) if (this.wrapper.fallbackType === "int32") n = Rn(t, this.wrapper.type), this.wrapper.setIsDataConverted(!0);
				...
				registerTensor(t, n, r, o) {
					let i = this.getMLContext(t), s = mo(), a = new qt({
						sessionId: t,
						context: i,
						tensor: n,
						dataType: r,
		...
		var jt, dd, Zt, _o = k(() => {
			...
			jt = new Map([
				...
				isGraphInputOutputTypeSupported(t, n, r = !0) {
					...
					return typeof o > "u" ? !1 : r ? !!i?.input.dataTypes.includes(o) : !!i?.output.dataTypes.includes(o);
				}
				flush() {}
			};
		});
		...
		var wo, Vn, Nn, ld, cd, $o, Wn, Ln, xo, So = k(() => {
			...
			wo = new Map([
				...
				[134217728, 6],
				[167772160, 6]
			]), Vn = [], Nn = (e) => Math.ceil(Number(e) / 16) * 16, ld = (e) => {
				...
				let o = Nn(n), i = e.device.createBuffer({
					size: o,
             ...
             Please use the previous external buffer!`);
					...
					return this.storageCache.set(o, {
						...
						originalSize: n
					}), Z("verbose", () => `[WebGPU] GpuDataManager.registerExternalBuffer(size=${n}) => id=${o}, registered.`), o;
				}
				...
				create(t, n = GPUBufferUsage.STORAGE | GPUBufferUsage.COPY_SRC | GPUBufferUsage.COPY_DST) {
					...
					if (i || s) {
						...
						d ? d.length > 0 ? o = d.pop() : o = this.backend.device.createBuffer({
							size: r,
							usage: n
					...
					return this.storageCache.set(a.id, {
						gpuData: a,
						originalSize: Number(t)
					}), Z("verbose", () => `[WebGPU] GpuDataManager.create(size=${t}) => id=${a.id}`), a;
				}
				get(t) {
		...
		var Je, Fn, re, pe, P, J, qn, et, Ie, D, Xt, S, C, To, Yt, Hn, Io, q = k(() => {
			...
			Je = 64, Fn = (e, t) => {
				...
				let i = typeof n == "number", s = i ? n : n.length, a = [...new Array(s).keys()], u = s < 2 ? "u32" : s <= 4 ? `vec${s}<u32>` : `array<u32, ${s}>`, d = Fn(t, o), l = typeof d == "string" ? d : d[1], p = {
					indices: u,
					value: l,
					storage: typeof d == "string" ? d : d[0],
					tensor: t
				}, f = (A) => typeof A == "string" ? A : `${A}u`, m = {
					offsetToIndices: !1,
					indicesToOffset: !1,
					...
					get: !1,
					getByIndices: !1
				}, h = i ? "uniforms." : "", _ = `${h}${e}_shape`, y = `${h}${e}_strides`, g = "";
  ...
  fn o2i_${e}(offset: u32) -> ${p.indices} {
    ...
    ${g}
    return indices;
  }`, w = (A) => (m.offsetToIndices = !0, s < 2 ? A : `o2i_${e}(${A})`), v = [];
				if (s >= 2) for (let A = s - 1; A >= 0; A--) v.push(`${D(y, A, s)} * (indices[${A}])`);
				let $ = s < 2 ? "" : `
  fn i2o_${e}(indices: ${p.indices}) -> u32 {
    return ${v.join("+")};
  }`, T = (A) => (m.indicesToOffset = !0, s < 2 ? A : `i2o_${e}(${A})`), I = (...A) => s === 0 ? "0u" : `${p.indices}(${A.map(f).join(",")})`, E = (A, B) => s < 2 ? `${A}` : `${D(A, B, s)}`, z = (A, B, oe) => s < 2 ? `${A}=${oe};` : `${D(A, B, s)}=${oe};`, M = {}, O = (A, B) => {
  ...
  fn get_${e}(${a.map((oe) => `d${oe}: u32`).join(", ")}) -> ${l} {
    return get_${e}ByIndices(${I(a.map((oe) => `d${oe}`).join(", "))});
  }`, G = (...A) => {
					if (A.length !== s) throw new Error(`indices length must be ${s}`);
					let B = A.map(f).join(",");
					return s === 0 ? K("0u") : s === 1 ? K(B[0]) : (m.get = !0, m.getByIndices = !0, m.indicesToOffset = !0, `get_${e}(${B})`);
				}, V = (A) => s < 2 ? K(A) : (m.getByIndices = !0, m.indicesToOffset = !0, `get_${e}ByIndices(${A})`), j = s < 2 ? "" : `
  fn set_${e}ByIndices(indices: ${p.indices}, value: ${l}) {
    ${W(`i2o_${e}(indices)`, "value")}
  }`, Q = s < 2 ? "" : `
  fn set_${e}(${a.map((oe) => `d${oe}: u32`).join(", ")}, value: ${l}) {
    set_${e}ByIndices(${I(a.map((oe) => `d${oe}`).join(", "))}, value);
  }`;
				return {
					impl: () => {
						let A = [], B = !1;
						return m.offsetToIndices && (A.push(b), B = !0), m.indicesToOffset && (A.push($), B = !0), m.broadcastedIndicesToOffset && (Object.values(M).forEach((oe) => A.push(oe)), B = !0), m.set && (A.push(Q), B = !0), m.setByIndices && (A.push(j), B = !0), m.get && (A.push(R), B = !0), m.getByIndices && (A.push(U), B = !0), !i && B && A.unshift(`const ${_} = ${p.indices}(${n.join(",")});`, `const ${y} = ${p.indices}(${x.computeStrides(n).join(",")});`), A.join(`
`);
					},
					type: p,
					offsetToIndices: w,
					indicesToOffset: T,
					broadcastedIndicesToOffset: O,
					indices: I,
					indicesGet: E,
					indicesSet: z,
					set: (...A) => {
						...
						return s === 0 ? W("0u", B) : s === 1 ? W(oe[0], B) : (m.set = !0, m.setByIndices = !0, m.indicesToOffset = !0, `set_${e}(${oe}, ${B})`);
					},
					setByOffset: W,
					setByIndices: (A, B) => s < 2 ? W(A, B) : (m.setByIndices = !0, m.indicesToOffset = !0, `set_${e}ByIndices(${A}, ${B});`),
					get: G,
					getByOffset: K,
					getByIndices: V,
					usage: r,
...
`);
  ...
  ${h.mainStart()}
    ...
    output[global_idx] = input[global_idx];
				...
				let { newShape: l, newPerm: c } = hd(e.dims, o), p = x.areEqual(c, [
					2,
					3,
					1
				]), f = x.areEqual(c, [
        ...
        fn DIV_CEIL(a : u32, b : u32) -> u32 {
         ...
         if (local_idx == 0u) {
          ${c.setByOffset("outputIndex", `${r === "mean" ? `${c.type.storage}(bestValue / f32(uniforms.reduceSize))` : `${c.type.storage}(${wd[r]})`}`)};
				...
				d.length > 0 && (u = e.compute(me(e.inputs[0], d), {
					inputs: [0],
					outputs: [-1]
				})[0], a = $d(a.length, u.dims.length));
...
`)}
				...
				let n = [];
				return e[1].dims[0] > 0 && e[1].getBigInt64Array().forEach((r) => n.push(Number(r))), L({
					axes: n,
					keepDims: t.keepDims,
				...
				e.compute(en(t, {
					hint: i.cacheKey,
					inputDependencies: ["rank"]
				}, [o[0]], i.noopWithEmptyAxes && i.axes.length === 0 ? Cd : r, i.axes, o[0].dataType, i.keepDims, i.noopWithEmptyAxes), { inputs: [0] });
			}, Ad = (e, t) => {
				De(e.inputs), Oe(e, "ReduceLogSum", t, (r, o) => [
				...
				De(e.inputs), Oe(e, "ReduceL1", t, (r, o) => [
					`var value = ${o.type.storage}(0);`,
					"",
				...
				De(e.inputs), Oe(e, "ReduceL2", t, (r, o) => [
				...
				De(e.inputs), Oe(e, "ReduceLogSumExp", t, (r, o) => [
					`var value = ${o.type.storage}(0);`,
					"",
...
`)}`,
				...
				De(e.inputs), Oe(e, "ReduceProd", t, (r, o) => [
				...
				De(e.inputs), Oe(e, "ReduceSum", t, (r, o) => [
					`var value = ${o.type.storage}(0);`,
					"",
					`value += ${r.getByIndices("input_indices")};`,
					""
				...
				De(e.inputs), Oe(e, "ReduceSumSquare", t, (r, o) => [
					`var t = ${o.type.value}(0); var value = ${o.type.value}(0);`,
					"",
					`t = ${r.getByIndices("input_indices")}; value += t * t;`,
					""
...
var best_index : i32 = 0;`,
    ...
    `, Vd = (e, t, n, r, o, i, s, a) => {
				...
				], f = re(e.dataType, u), m = pe(1, u), h = ["type"];
  ...
  ${y.mainStart([
    ...
    thread_max[local_idx] = ${(() => {
						switch (u) {
							...
							default: throw new Error(`Unsupported components: ${u}`);
						}
					})()};
    workgroupBarrier();
      ...
      ${s ? `
        for (var total_seq_id: u32 = seq_causal_length; total_seq_id + local_offset < uniforms.total_sequence_length; total_seq_id++) {
          x[offset + total_seq_id] = ${g.type.value}(${$}(0));
				...
				let d = s + i.kvSequenceLength, l = [
					i.batchSize,
					i.numHeads,
					i.sequenceLength,
					d
				], c = e > 1 && r, p = i.kvNumHeads ? i.kvNumHeads : i.numHeads, f = c ? [
					i.batchSize,
					p,
					d,
					i.headSize
				] : void 0, m = i.nReps ? i.nReps : 1, h = i.scale === 0 ? 1 / Math.sqrt(i.headSize) : i.scale, _ = J(i.headSize), y = i.headSize / _, g = 12, b = {
					x: Math.ceil(d / g),
				...
				], v = c && r && x.size(r.dims) > 0, $ = ["type", "type"];
				...
				let I = (E) => {
					let z = S("q", t.dataType, t.dims, _), O = [z, S("key", n.dataType, n.dims, _)];
					if (v) {
    ...
    if (global_id.y < uniforms.M && global_id.x < total_sequence_length) {
      ...
      var sum: f32 = ${(() => {
						switch (_) {
							...
							default: throw new Error(`Unsupported components: ${_}`);
						}
					})()};
        output[outputIdx] = ${U.type.value} (sum * uniforms.alpha) + ${o ? "attention_bias[outputIdx]" : "0.0"};
				...
				let u = i + o.kvSequenceLength, d = o.nReps ? o.nReps : 1, l = o.vHiddenSize * d, c = e > 1 && r, p = o.kvNumHeads ? o.kvNumHeads : o.numHeads, f = c ? [
					o.batchSize,
					p,
					u,
					o.headSize
				...
				], g = c && r && x.size(r.dims) > 0, b = ["type", "type"];
				...
				let v = ($) => {
					let T = S("probs", t.dataType, t.dims), E = [T, S("v", n.dataType, n.dims)];
  ...
  ${$.mainStart([
   ...
   if (m < uniforms.M && n < uniforms.N) {
     ...
     output[outputIdx] = value;
			...
			}, st = (e, t, n, r, o, i, s, a, u, d, l = void 0, c = void 0) => {
				let p = Math.min(e.outputCount, 1 + (s ? 1 : 0) + (a ? 1 : 0)), f = p > 1 ? s : void 0, m = p > 1 ? a : void 0, h = p > 1 ? d.pastSequenceLength : 0, _ = h + d.kvSequenceLength, y = u && x.size(u.dims) > 0 ? u : void 0, g = [t, n];
				f && x.size(f.dims) > 0 && g.push(f), y && g.push(y), l && g.push(l), c && g.push(c);
				let b = e.compute(Nd(p, t, n, f, y, d, h, l, c), {
					inputs: g,
					outputs: p > 1 ? [-1, 1] : [-1]
				})[0];
				e.compute(Vd(b, d.batchSize, d.numHeads, h, d.sequenceLength, _, l, c), {
					inputs: l && c ? [
						b,
						l,
						c
				...
				let w = [b, r];
				m && x.size(m.dims) > 0 && w.push(m), l && w.push(l), c && w.push(c), e.compute(Ld(p, b, r, m, d, h, l, c), {
					inputs: w,
					outputs: p > 1 ? [0, 2] : [0]
				});
			}, Wd = (e, t) => {
				let n = [
					...
					t.sequenceLength,
					t.headSize
				], r = t.sequenceLength, o = t.inputHiddenSize, i = t.headSize, s = 12, a = {
					...
					let p = C("output_q", u[0].dataType, n), f = C("output_k", u[0].dataType, n), m = C("output_v", u[0].dataType, n), h = S("input", u[0].dataType, u[0].dims), _ = S("weight", u[1].dataType, u[1].dims), y = S("bias", u[2].dataType, u[2].dims), g = h.type.storage;
					return `
  const TILE_SIZE = ${s}u;
  ...
  ${c.mainStart([
    ...
    if (m < uniforms.M && n < uniforms.N) {
      ...
      output_v[outputIdx] = valueV;
				...
				return st(e, r, o, i, e.inputs[4], void 0, void 0, void 0, e.inputs[5], n);
			};
		});
  ...
  ${b.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.outputSize")}
    ...
    ${_.setByOffset("global_idx", "value")}
				...
				let { inputs: n, outputCount: r } = e, o = Fd({
					...t,
					outputCount: r
				});
				if (te.webgpu.validateInputContent && Gd(n, o), t.trainingMode) throw new Error("BatchNormalization trainingMode is not supported yet.");
				e.compute(Hd(n, o));
			};
		});
		var qd, Kd, oi, ii = k(() => {
    ...
    ${u.setByOffset("global_idx", "value")}
		...
		var jd, ee, si, ai, ui, di, li, ci, pi, mi, fi, Zd, hi, gi, yi, bi, bt, _i, nn, wi, $i, vi, xi, Si, Ti, Ii, Ci, Ai, Ei, ki, Pi, zi, Bi, Di, Oi, Mi, Ui, Qn, Xn, Ri, Vi, Ni, Qd, Xd, Li, rn = k(() => {
			...
			jd = (e, t, n, r, o, i, s) => {
				...
				let d = S("inputData", n, [a], 4), l = C("outputData", r, [a], 4), c = [{
					name: "vec_size",
					type: "u32"
				}];
				return s && c.push(...s), `
  ...
  ${e.mainStart()}
    ...
    ${l.setByOffset("global_idx", u)}
				...
				let u = [{
					type: 12,
					data: Math.ceil(x.size(e.dims) / 4)
				}];
				return s && u.push(...s), {
					name: t,
					shaderCache: {
					...
					getShaderSource: (d) => jd(d, x.size(e.dims), e.dataType, i, n, r, a),
					getRunData: (d) => ({
						outputs: [{
							dims: e.dims,
							dataType: i
				...
				e.compute(ee(e.inputs[0], "Clip", (o) => `clamp(${o}, vec4<${r}>(uniforms.min), vec4<${r}>(uniforms.max))`, void 0, n.cacheKey, void 0, [{
  ...
  ${u.mainStart()}
    ...
    ${o.setByOffset("global_idx", "valueLeft * geluRight")}
        ...
        ${y}
				...
				let a = n.dims.map(Number), u = r.dims.map(Number), d = !x.areEqual(a, u), l = a, c = x.size(a), p = !1, f = !1, m = [d];
				if (d) {
					let h = ze.calcShape(a, u, !1);
				...
				return m.push(p), {
					...
					getShaderSource: (h) => el(h, a, u, l, p, d, f, o, n.dataType, r.dataType, s, i),
					getRunData: () => ({
						outputs: [{
							dims: l,
							dataType: s
...
`);
				...
				let o = x.size(n), i = new Array(e.length), s = new Array(e.length), a = 0, u = [], d = [], l = [{
					type: 12,
					data: o
				}];
				for (let h = 0; h < e.length; ++h) a += e[h].dims[t], i[h] = a, d.push(e[h].dims.length), s[h] = S(`input${h}`, r, d[h]), u.push("rank"), l.push({
					type: 12,
					data: i[h]
				});
...
`;
				...
				let s = e[0].dims, a = e[1].dims, u = s[s.length - 2], d = a[a.length - 1], l = s[s.length - 1], c = J(d), p = J(l), f = J(u), m = x.size(n) / c / f, h = e.length > 2, _ = r ? r.slice(0, -2) : n.slice(0, -2), g = [
					x.size(_),
					u,
					d
				], b = [
...
`;
  ...
  `;
        ...
        }`, Yn = (e, t, n = "f32", r, o = !1, i = 32, s = !1, a = 32) => {
...
fn main(@builtin(local_invocation_id) localId : vec3<u32>,
  ...
  for (var innerRow = 0; innerRow < rowPerThread; innerRow = innerRow + 1) {
      mm_write(batch, globalRow + innerRow, globalCol, acc[innerRow]);
            ...
            `, dl = (e) => e ? "let ACached = mm_Asub[k][tileRow + innerRow];" : "let ACached = mm_Asub[tileRow + innerRow][k];", Jn = (e, t, n = "f32", r, o = !1, i = 32, s = !1, a = 32, u = !1) => {
...
`;
    ...
    `;
				...
				let s = e[0].dims, a = e[1].dims, u = s.slice(0, -2), d = a.slice(0, -2), l = r ? r.slice(0, -2) : n.slice(0, -2), c = x.size(l), p = s[s.length - 2], f = s[s.length - 1], m = a[a.length - 1], h = f % 4 === 0 && m % 4 === 0, _ = p <= 8 ? [
					4,
					1,
					1
				] : [
				...
				let O = (W) => {
					...
					Ee(t, X);
					let Te = re(j.type.tensor), se = Ce(t, j.type.value, Te), A = ll(b, M, se, [
						U,
						G,
						V,
						j
  ...
  ${h ? Yn(_, y, R, U) : Jn(_, y, R, U)}
			...
			cl = (e, t, n, r, o = !1, i, s = 4, a = 4, u = 4, d = "f32") => {
				let l = (z) => {
					switch (z) {
						...
						case 3: return `resData = vec3<${d}>(x[xIndex], x[xIndex + 1], x[xIndex + 2]);`;
						case 4: return "resData = x[xIndex / 4];";
						default: throw new Error(`innerElementSize ${z} is not supported.`);
					}
				}, c = (z) => {
					switch (z) {
    ...
    fn mm_write(batch: i32, row : i32, colIn : i32, valueIn : ${v}) {
      ...
      setOutputAtCoords(coords[0], coords[1], coords[2], coords[3], value);
				...
				let d = t.format === "NHWC", l = d ? e[0].dims[3] : e[0].dims[1], c = n[0], p = d ? n[2] : n[3], f = d ? n[1] : n[2], m = d ? n[3] : n[1], h = d && (l % 4 === 0 || l % 3 === 0) && m % 4 === 0, _ = d ? m : p * f, y = d ? p * f : m, g = [
					8,
					8,
					1
				], b = r <= 8 ? [
				...
				let v = h ? d && l % 4 !== 0 ? 3 : 4 : 1, $ = g[1] * b[1], T = g[0] * b[0], I = Math.max(g[0] * v, g[1]), E = r % $ === 0, z = o % T === 0, M = i % I === 0, O = h ? [
					v,
					4,
					4
				] : [
      ...
      fn setOutputAtCoords(d0 : i32, d1 : i32, d2 : i32, d3 : i32, value : ${h ? `vec4<${j}>` : j}) {
      ...
      }`, se = [S("x", e[0].dataType, e[0].dims.length, v === 3 ? 1 : v), S("w", e[1].dataType, e[1].dims.length, V)], A = C("result", e[0].dataType, n.length, V);
					if (s) {
        ...
        ${h ? Yn(b, g, j, void 0, !d, I) : Jn(b, g, j, void 0, !d, I, !1, void 0, a)}`;
				};
				return {
					name: "Conv2DMatMul",
					shaderCache: {
						hint: `${t.cacheKey};${v};${h};${E};${z};${M};${$};${T};${I}`,
						inputDependencies: K
					},
					getRunData: () => ({
						outputs: [{
		...
		var pl, cs, ln, ml, ps, fl, ms, fs, hs = k(() => {
			...
			pl = (e) => {
				...
				return t;
			}, cs = (e) => typeof e == "number" ? [
				e,
				e,
				e
			] : e, ln = (e, t) => t <= 1 ? e : e + (e - 1) * (t - 1), ml = (e, t, n, r = 1) => {
				let o = ln(t, r);
				...
				if (e === "VALID" && (e = 0), typeof e == "number") {
					...
					let m = (c - 1) * o + a - t, h = (p - 1) * i + u - n, _ = (f - 1) * s + d - r, y = Math.floor(m / 2), g = m - y, b = Math.floor(h / 2), w = h - b, v = Math.floor(_ / 2);
					l = {
						top: b,
						bottom: w,
						left: v,
			...
			}, ms = (e, t, n, r, o, i = !1, s = "channelsLast") => {
				let a, u, d, l, c;
				if (s === "channelsLast") [a, u, d, l, c] = e;
				else if (s === "channelsFirst") [a, c, u, d, l] = e;
				else throw new Error(`Unknown dataFormat ${s}`);
				let [p, , f, m, h] = t, [_, y, g] = cs(n), [b, w, v] = cs(r), $ = ln(f, b), T = ln(m, w), I = ln(h, v), { padInfo: E, outDepth: z, outHeight: M, outWidth: O } = fl(o, u, d, l, _, y, g, $, T, I), W = i ? p * c : p, K = [
					0,
					0,
					0,
					0,
				...
				let d = [
					...
					Math.ceil(pl(l.x.map((g) => n[g])) / d[0]),
					1,
					1
				];
				...
				let y = (g) => {
					...
					Ee(t, b);
					let w = 1, v = re(e[0].dataType), $ = S("x", e[0].dataType, e[0].dims.length, p === 3 ? 1 : p), T = S("W", e[1].dataType, e[1].dims.length, w), I = [$, T], E = C("result", e[0].dataType, n.length, w), z = "";
					if (_) {
		...
		var gs, ys, bs = k(() => {
			...
			Ke();
			gs = (e, t, n, r) => {
				let o = e.length > 2, i = o ? "value += b[output_channel];" : "", s = e[0].dims, a = e[1].dims, u = t.format === "NHWC", d = u ? n[3] : n[1], l = d / t.group, c = u && l >= 4 ? J(d) : 1, p = x.size(n) / c, f = [
					{
						type: 12,
						data: p
					},
  ...
  ${_.mainStart()}
    ...
    ${y.setByOffset("global_idx", "value")}
				...
				let o = e.length > 2, i = J(n[3]), s = J(n[2]), a = x.size(n) / i / s, u = [
					e[0].dims[0],
					e[0].dims[1],
					e[0].dims[2],
					e[0].dims[3] / i
    ...
    for (var i = 0u; i < ${s}u; i++) {
      ...
      ${h.set("batch", "row", "col + i", "output_channel", "value")};
		...
		var hl, er, gl, tr, nr, _s, yl, bl, rr, ws = k(() => {
			...
			hl = (e, t, n, r, o, i) => {
				...
				if (n.group !== 1) {
					let $ = [t[0]];
					if (o) {
						let I = e.kernelCustomData.wT ?? e.compute(me(t[1], er), {
							inputs: [1],
				...
				if (h || l === 1 && c === 1 && n.dilations[0] === 1 && n.dilations[1] === 1 && n.strides[0] === 1 && n.strides[1] === 1 && n.pads[0] === 0 && n.pads[1] === 0) {
					let $ = i[0], T, I, E, z = [];
					if (o) {
						let W = e.kernelCustomData.wT ?? e.compute(me(t[1], er), {
							inputs: [1],
							outputs: [n.wIsConst ? -2 : -1]
						})[0];
				...
				let _ = !0, y = e.kernelCustomData.wT ?? e.compute(me(t[1], er), {
					inputs: [1],
					outputs: [n.wIsConst ? -2 : -1]
				})[0];
				...
				let o = [
					...
					0,
					t.pads[1]
				], i = [1].concat(t.strides), s = [1].concat(t.dilations), a = [1].concat(t.kernelShape), u = tr({
					...t,
					pads: o,
					strides: i,
					dilations: s,
				...
				let r = n.format === "NHWC" ? "channelsLast" : "channelsFirst", o = tr(n, t), i = n.autoPad === "NOTSET" ? n.pads : n.autoPad, s = ms(t[0].dims, t[1].dims, n.strides, n.dilations, i, !1, r);
				e.compute(fs(t, o, s.outShape, [
					s.filterDepth,
					s.filterHeight,
					s.filterWidth
				], [
		...
		var $s, vs = k(() => {
			...
			q();
			$s = (e, t, n) => {
				let r = e.length > 2, o = t.outputShape, i = t.format === "NHWC", s = t.group, a = e[1].dims, u = a[2] / s, d = a[3], l = i ? J(u) : 1, c = i && d === 1 && u >= 4, p = c ? Math.floor(u / 4) * 4 : Math.floor(u / l) * l, f = u - p, m = i ? J(d) : 1, h = i ? d === 1 ? l : m : 1, _ = x.size(o) / m, y = [
					Math.ceil(_ / 64),
					1,
					1
				];
				Z("verbose", () => `[conv2d_backprop_webgpu] dispatch = ${y}`);
				let g = ["rank", "rank"], b = [t.strides[0], t.strides[1]], w = [t.kernelShape[i ? 1 : 2], t.kernelShape[i ? 2 : 3]], v = [t.dilations[0], t.dilations[1]], $ = [w[0] + (t.dilations[0] <= 1 ? 0 : (t.kernelShape[i ? 1 : 2] - 1) * (t.dilations[0] - 1)), w[1] + (t.dilations[1] <= 1 ? 0 : (t.kernelShape[i ? 2 : 3] - 1) * (t.dilations[1] - 1))], T = [$[0] - 1 - Math.floor((t.pads[0] + t.pads[2]) / 2), $[1] - 1 - Math.floor((t.pads[1] + t.pads[3]) / 2)], I = [
					{
						type: 12,
						data: _
					},
				...
				let E = (z) => {
					...
					], O = re(e[0].dataType), W = i ? 1 : 2, K = i ? 2 : 3, U = i ? 3 : 1, R = S("W", e[1].dataType, e[1].dims.length, h), G = S("Dy", e[0].dataType, e[0].dims.length, l), V = [G, R];
    ...
    ${Te}}`;
		...
		var _l, wl, $l, xs, Ss, vl, Ts, xl, Is, Cs = k(() => {
			...
			_l = (e, t, n, r, o, i) => (e - 1) * t + n + (r - 1) * o + 1 - i, wl = (e, t, n, r, o) => {
				...
				let t = on(e), n = e.format, r = [
					"NOTSET",
					"VALID",
					"SAME_UPPER",
					"SAME_LOWER"
				][typeof e.autoPad > "u" ? 0 : e.autoPad], o = e.dilations, i = e.group ?? 1, s = e.kernelShape, a = e.pads, u = e.strides, d = e.wIsConst();
				return {
					autoPad: r,
					format: n,
					dilations: o,
				...
				let o = e.kernelCustomData.wT ?? e.compute(me(t[1], [
					2,
					3,
					0,
					1
				...
				return {
					...
					getRunData: (y) => {
						let g = u ? [
							...
							r * d,
							o * d
						], b = x.size(g), w = c.dims, v = x.sortBasedOnPerm(w, a);
						return {
							outputs: [{
								dims: g,
								dataType: y[0].dataType
							}],
		...
		var or, cn, Ds, Al, El, ir, sr, Os, kl, Ms, Us, Rs = k(() => {
			...
			or = "[a-zA-Z]|\\.\\.\\.", cn = "(" + or + ")+", Ds = "^" + cn + "$", Al = "(" + cn + ",)*" + cn, El = "^" + Al + "$", ir = class {
				...
				let i = e.map((l) => l.length).map((l, c) => S(`input${c}`, t, l)), s = x.size(r), a = C("output", t, r.length), u = [...n.symbolToInfo.keys()].filter((l) => !n.rhs.symbolToIndices.has(l)), d = (l) => {
					...
					let w = b ? [...c, `let sum = ${i.map((v, $) => v.getByIndices(`input${$}Indices`)).join(" * ")};`] : [
						...c,
						f,
						..._,
						...h,
					...
					return `
            ${l.registerUniforms(u.map((v) => ({
						name: `${Os(v)}`,
						type: "u32"
					}))).registerUniform("outputSize", "u32").declareVariables(...i, a)}
...
`)};
		...
		var Dl, Ws, Gs = k(() => {
			...
			Dl = (e) => {
				let t = e[0].dataType, n = x.size(e[0].dims), r = x.size(e[1].dims), o = r % 4 === 0, i = (s) => {
					let a = S("x", t, [1], 4), u = S("bias", t, [1], 4), d = C("y", t, [1], 4), l = [{
      ...
      ${d.setByOffset("global_idx", Xn("x_in"))}
				...
				return {
					...
					getRunData: (s) => ({
						...
						dispatchGroup: { x: Math.ceil(n / Je / 4) }
					})
				};
			}, Ws = (e) => {
		...
		var Ol, Ml, Hs, Fs, qs = k(() => {
			...
			Ol = (e) => {
				...
				s.splice(i, 1, ...r);
				let a = n[i], u = e[0].dataType === 9 ? 4 : 1, d = Math.ceil(x.size(s) / u), l = [
					{
						type: 12,
						data: d
					},
      ...
      ${p.mainStart()}
		...
		var Ul, Ks, js, Zs = k(() => {
			...
			Ul = (e, t, n, r, o, i, s, a, u) => {
				...
				d.push(...P(t.dims, l));
				let c = (p) => {
					let h = [S("indices_data", t.dataType, t.dims.length), C("input_slice_offsets_data", 12, 1, 1)], _ = [
						{
							name: "output_size",
							type: "u32"
						},
  ...
  ${p.mainStart()}
    ...
    input_slice_offsets_data[global_idx] =  base_offset + u32(relative_slice_offset);
				...
				let _ = i.slice(0, -1).concat(r.slice(h)), y = x.size(_), g = [
					{
						type: 12,
						data: y
					},
		...
		var Rl, Vl, Qs, Xs, Ys = k(() => {
			...
			Rl = (e, t) => {
				...
				if (i.dims.length !== o.dims.length || !o.dims.map((a, u) => u === n ? Math.ceil(a / r) === i.dims[u] : a === i.dims[u]).reduce((a, u) => a && u, !0)) throw new Error("Scales must have the same rank as the input tensor and the dims should match except on gatherAxis.");
				if (s) {
					if (s.dataType !== o.dataType) throw new Error("Zero point must have the same data type as the input tensor.");
					if (s.dims.length !== i.dims.length || !s.dims.map((a, u) => a === i.dims[u]).reduce((a, u) => a && u, !0)) throw new Error("Zero point must have the same rank as the input tensor and the dims should match except on quantizeAxis.");
				}
			}, Vl = (e, t) => {
				let n = e[0].dims, r = e[1].dims, o = n.length, i = x.normalizeAxis(t.gatherAxis, o), s = x.normalizeAxis(t.quantizeAxis, o), a = n.slice(0);
				a.splice(i, 1, ...r);
				let u = x.size(a), d = e[2].dataType, c = e[0].dataType === 22, p = [
					{
						type: 12,
						data: u
					},
					...
					let h = S("data", e[0].dataType, e[0].dims.length), _ = S("inputIndices", e[1].dataType, e[1].dims.length), y = S("scales", e[2].dataType, e[2].dims.length), g = e.length > 3 ? S("zeroPoint", e[3].dataType, e[3].dims.length) : void 0, b = C("output", d, a.length), w = [
						h,
						_,
						y
					];
        ...
        ${b.setByOffset("global_idx", "dequantized_data")};
				...
				return {
					...
					shaderCache: {
						hint: `${t.cacheKey};${e.filter((m, h) => h !== 1).map((m) => m.dims.join("_")).join(";")}`,
		...
		var Nl, Ll, Js, ea, ta = k(() => {
			...
			Nl = (e) => {
				...
				let n = e[0].dims, r = e[0].dataType, o = n.length, i = e[1].dims, s = e[1].dataType, a = x.normalizeAxis(t.axis, o), u = n[a], d = i.slice(0), l = x.size(d), c = S("input", r, o), p = S("indicesInput", s, i.length), f = C("output", r, d.length), m = [
					{
						type: 12,
						data: l
					},
      ...
      ${f.setByOffset("global_idx", "value")};
		...
		var Wl, Gl, na, ra, oa = k(() => {
			...
			Wl = (e) => {
				...
				let u = 16, d = Math.ceil(i / u), l = Math.ceil(o / u);
				x.size(a);
				let f = [
					{
						type: 12,
...
`, Ql = (e, t, n) => (() => {
        ...
        `;
				...
				let n = S("x", e[0].dataType, e[0].dims.length), r = [
					e[1].dims[0],
					e[1].dims[1],
					e[1].dims[2]
				], o = S("grid", e[1].dataType, r.length, 2), i = [
					e[0].dims[0],
					e[0].dims[1],
					e[1].dims[1],
					e[1].dims[2]
				...
				let s = C("output", e[0].dataType, i.length), a = n.type.value, d = [{
					type: 12,
					data: x.size(i)
				}, ...P(e[0].dims, r, i)], l = (c) => `
    ...
    ${c.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.output_size")}
      ...
      ${Ql(s, a, t)}
		...
		var _e, ec, da, ua, tc, $t, la, ar = k(() => {
			...
			q();
			Ne();
			_e = (e, t) => e.length > t && e[t].dims.length > 0 ? e[t] : void 0, ec = (e, t) => {
				...
				if (s && x.size(s.dims) > 0) {
					b = 8;
					let T = s.dims;
					throw T.length === 1 ? T[0] === l ? b = 1 : T[0] === 3 * l + 2 && (b = 3) : T.length === 2 && T[0] === l && T[1] === g && (b = 5), b === 8 ? /* @__PURE__ */ new Error("Input \"key_padding_mask\" shape shall be (batch_size) or (batch_size, total_sequence_length)") : /* @__PURE__ */ new Error("Mask not supported");
				}
				let w = !1, v = p;
				...
				let a = [
					...
					let p = C("qkv_with_bias", t.dataType, a), f = S("qkv", t.dataType, a), m = S("bias", n.dataType, a);
					return `
  ${c.registerUniforms([
						{
							name: "output_size",
  ...
  ${c.mainStart()}
    ...
    qkv_with_bias[global_idx] = qkv[global_idx] + bias[bias_offset_idx];
				...
				if (s && x.size(s.dims) > 0) {
					...
					return u = tc(e, i, s, t, r, n * o, a), u = u.reshape([
						t,
						r,
						n,
						o
					]), n === 1 || r === 1 ? u : e.compute(me(u, ua.perm), {
						inputs: [u],
						outputs: [-1]
					})[0];
				} else return i.dims.length === 3 && (u = i.reshape([
					t,
					r,
					n,
					o
				...
				if (c) return st(e, p, o, i, a, void 0, d, l, u, n);
		...
		var nc, rc, oc, ic, ur, ca, pa, dr = k(() => {
			...
			nc = (e) => {
				...
				return e[1].dims[0] > 0 && (e[1].getBigInt64Array().forEach((o) => n.push(Number(o))), r = n.length), L({
					numOutputs: r,
					axis: t.axis,
					splitSizes: n
				});
...
`)}
				...
				let n = e[0].dims, r = x.size(n), o = e[0].dataType, i = x.normalizeAxis(t.axis, n.length), s = new Array(t.numOutputs), a = S("input", o, n.length), u = new Array(t.numOutputs), d = [], l = [], c = 0, p = [{
					type: 12,
					data: r
				}];
				for (let m = 0; m < t.numOutputs; m++) {
					...
					let h = n.slice();
					h[i] = t.splitSizes[m], l.push(h), s[m] = C(`output${m}`, o, h.length), d.push({
						dims: l[m],
						dataType: e[0].dataType
					});
				}
    ...
    writeBufferData(output_number, indices, global_idx);
		...
		var sc, pn, ma, lr = k(() => {
			...
			sc = (e, t) => {
				...
				let { interleaved: n, numHeads: r, rotaryEmbeddingDim: o, scale: i } = t, s = e[0].dims[0], a = x.sizeFromDimension(e[0].dims, 1), u = e[0].dims[e[0].dims.length - 2], d = a / u, l = e[2].dims[1], c = o === 0 ? l * 2 : d / r, p = new Array(s, u, d / c, c - l), f = x.computeStrides(p), m = [
					{
						type: 1,
						data: i
					},
            ...
            ${v.setByOffset("k", y.getByOffset("k"))}
				...
				return {
					...
					getRunData: () => ({
						...
						dispatchGroup: { x: Math.ceil(x.size(p) / Je) },
						programUniforms: m
					})
				};
			}, ma = (e, t) => {
		...
		var ac, uc, fa, dc, ha, ga = k(() => {
			...
			ac = (e, t) => {
				...
				if (n.dims.length !== 3 && n.dims.length !== 5) throw new Error("Input query is expected to have 3 or 5 dimensions");
				let u = n.dims[0], d = n.dims[1], l = n.dims.length === 3 ? n.dims[2] : t.numHeads * n.dims[4], c = d, p = 0, f = !r || r.dims.length === 0, m = Math.floor(f ? l / (t.numHeads + 2 * t.kvNumHeads) : l / t.numHeads);
				f && (l = m * t.numHeads);
				...
				let b = 0, w = !1, v = t.kvNumHeads ? m * t.kvNumHeads : l;
				...
				return t.dims.length === 3 && n.kvSequenceLength !== 0 && (r = t.reshape([
					...
					o,
					n.headSize
				]), r = e.compute(me(r, uc.perm), {
					inputs: [r],
					outputs: [-1]
				})[0]), r;
			}, dc = (e, t, n, r) => {
				let o = 7, i = ["type", "type"], s = [e * t], a = e * t, u = [
					{
						type: 12,
						data: a
					},
					...
					let c = S("seq_lens", n.dataType, n.dims), p = S("total_seq_lens", r.dataType, r.dims), f = C("pos_ids", o, s);
					return `
  ${l.registerUniforms([
						{
							name: "output_size",
  ...
  `;
				...
				let y = $t(e, n.batchSize, n.numHeads, n.sequenceLength, n.headSize, t.doRotary ? h : p, void 0, 0), g = fa(e, t.doRotary ? _ : f, n), b = fa(e, m, n);
				st(e, y, g, b, void 0, void 0, s, a, void 0, n, u, d);
			};
		});
		var ya, lc, cc, ba, _a = k(() => {
			...
			ya = (e, t, n, r, o, i, s, a) => {
				...
				_.push(...P(f, m));
				let y = (g) => {
					let b = S("x", t.dataType, 3, u), T = [
						b,
						S("scale", n.dataType, n.dims),
						S("bias", r.dataType, r.dims),
						C("output", 1, 3, 2)
					];
					return `
  ...
  ${g.mainStart(p)}
    ...
    if (local_idx == 0) {
      ...
      output[workgroup_index] = vec2f(channel_scale, channel_shift);
				...
				let r = t[0].dims, o = r, i = 2, s = r[0], a = r[1], u = x.sizeFromDimension(r, i), d = J(u), l = x.size(o) / d, c = ya(e, t[0], t[1], t[2], s, u, a, n.epsilon), p = [
					s,
					a,
					u / d
				], f = [s, a], m = ["type", "none"], h = (_) => {
					let y = S("x", t[0].dataType, p.length, d), g = S("scale_shift", 1, f.length, 2), b = C("output", t[0].dataType, p.length, d), w = [
						y,
						g,
						b
					];
  ...
  ${_.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.output_size")}
      ...
      ${b.setByOffset("global_idx", "value")};
				...
				let r = t[0].dims, o = r, i = r[0], s = r[r.length - 1], a = x.sizeFromDimension(r, 1) / s, u = J(s), d = x.size(o) / u, l = [{
					type: 12,
					data: a
				}, {
					type: 12,
					data: Math.floor(s / u)
				}], c = ["type", "type"], p = !1, f = [0, r.length - 1];
				for (let y = 0; y < r.length - 2; y++) p = p || r[y + 1] !== 1, f.push(y + 1);
				p = p && r[r.length - 1] !== 1;
				let m = p ? e.compute(me(e.inputs[0], f), {
					inputs: [e.inputs[0]],
					outputs: [-1]
				})[0] : e.inputs[0].reshape(Array.from({ length: r.length }, (y, g) => r[f[g]])), h = ya(e, m, t[1], t[2], i, a, s, n.epsilon), _ = (y) => {
					let g = re(t[0].dataType), b = u === 1 ? "vec2f" : `mat${u}x2f`, w = (T) => {
						let I = T === 0 ? "x" : "y", E = u === 1 ? "f32" : `vec${u}f`;
						switch (u) {
							case 1: return `${g}(${E}(scale.${I}))`;
							case 2: return `vec2<${g}>(${E}(scale[0].${I}, scale[1].${I}))`;
							case 4: return `vec4<${g}>(${E}(scale[0].${I}, scale[1].${I}, scale[2].${I}, scale[3].${I}))`;
							default: throw new Error(`Not supported compoents ${u}`);
						}
    ...
    ${g ? "inv_std_output[global_idx] = inv_std_dev" : ""};
		...
		var fc, va, xa = k(() => {
			...
			fc = (e) => {
				...
				fc(e.inputs);
				let t = ze.calcShape(e.inputs[0].dims, e.inputs[1].dims, !0);
				...
				if (n < 8 && r < 8) e.compute(an(e.inputs, { activation: "" }, t));
					...
					if (i !== 1 && o === 1 && s === 1) {
						let a = e.inputs[0].reshape([
							1,
							i,
							r
						]), u = e.inputs[1].reshape([
							1,
							r,
							n
						]), d = [
					...
					} else e.compute(wt(e.inputs, { activation: "" }, t));
				}
			};
		});
		var hc, gc, yc, Sa, Ta, Ia = k(() => {
			...
			hc = (e, t) => {
				...
				let n = e[0].dims, r = n.length, o = n[r - 2], i = t.k, s = t.n, a = n.slice(0, r - 2), u = x.size(a), l = e[1].dims[2] / 4, c = e[0].dataType, p = J(t.k), f = J(l), m = J(s), h = a.concat([o, s]), _ = o > 1 && s / m % 2 === 0 ? 2 : 1, y = x.size(h) / m / _, g = 64, b = [], w = [
					u,
					o,
					i / p
				...
				b.push(...P($));
				let T = (I) => {
					let E = w.length, z = S("a", e[0].dataType, E, p), M = S("b", 12, v.length, f), O = S("scales", e[2].dataType, e[2].dims.length), W = [
						z,
						M,
						O
					], K = e.length === 4 ? S("zero_points", 12, e[3].dims.length) : void 0;
					K && W.push(K);
					let U = $.length, R = C("output", e[0].dataType, U, m), G = re(e[0].dataType), V = (() => {
						switch (p) {
							case 1: return `array<${G}, 8>`;
							case 2: return `mat4x2<${G}>`;
							case 4: return `mat2x4<${G}>`;
							default: throw new Error(`${p}-component is not supported.`);
						}
          ...
          if (local_id.x < ${_}) {
            ...
            ${R.setByIndices(`${R.type.indices}(batch, row, col + local_id.x)`, "output_value")};
				...
				return {
					name: "MatMulNBits",
					shaderCache: {
						hint: `${t.blockSize};${t.bits};${p};${f};${m};${_};${g}`,
				...
				let n = e[0].dims, r = n.length, o = n[r - 2], i = t.k, s = t.n, a = n.slice(0, r - 2), u = x.size(a), l = e[1].dims[2] / 4, c = e[0].dataType, p = J(t.k), f = J(l), m = a.concat([o, s]), h = 128, _ = s % 8 === 0 ? 8 : s % 4 === 0 ? 4 : 1, y = h / _, g = Math.floor(32 / t.bits), b = y * f * g, w = b / p, v = b / t.blockSize, $ = x.size(m) / _, T = [], I = [
					u,
					o,
					i / p
				], E = x.convertShape(e[1].dims).slice();
				...
				T.push(...P(z));
				let M = (O) => {
					let W = I.length, K = S("a", e[0].dataType, W, p), U = S("b", 12, E.length, f), R = S("scales", e[2].dataType, e[2].dims.length), G = [
						K,
						U,
						R
					], V = e.length === 4 ? S("zero_points", 12, e[3].dims.length) : void 0;
					V && G.push(V);
      ...
      `;
          ...
          `;
				...
				switch (n.mode) {
					case 0: return _c(e, t, n.pads.length);
					case 1: return wc(e, t, n.pads.length);
					case 2: return $c(e, t, n.pads.length);
					case 3: return vc(e, t, n.pads.length);
					default: throw new Error("Invalid mode");
				}
			}, Sc = (e, t) => {
				let n = x.padShape(e[0].dims.slice(), t.pads), r = e[0].dims, i = [{
					type: 12,
					data: x.size(n)
				}, {
					type: 6,
				...
				let a = ["rank"], u = (d) => {
					let l = C("output", e[0].dataType, n.length), c = S("x", e[0].dataType, r.length), p = c.type.value, f = xc(l, r.length, t), m = [{
						name: "output_size",
						type: "u32"
					}, {
						name: "pads",
		...
		var mn, Ea, ka, Pa, za, Ic, Cc, Ba, Da, Oa, Ma, Ua, Ra, Va, Na, La, Wa, Ga, Ha, Fa = k(() => {
			...
			mn = (e) => {
				...
				let n = t.format === "NHWC", r = x.size(e), o = x.size(t.kernelShape), i = [{
					type: 12,
					data: r
				}, {
					type: 12,
            ...
            ${e.mainStart()}
              ...
              output[global_idx] = value;
			...
			}, za = (e) => `${e.format};${e.ceilMode};${e.autoPad};${e.kernelShape.length}`, Ic = (e) => `${za(e)};${e.countIncludePad}`, Cc = (e) => `${za(e)};${e.storageOrder};${e.dilations}`, Ba = (e) => ({
				format: e.format,
				autoPad: [
					"NOTSET",
					"VALID",
				...
				return {
					...
					getShaderSource: (_) => Pa(_, s, t.dims.length, i.length, o, u, d, 0, c, p, f, m)
				};
			}, Oa = (e) => {
				...
				mn(e.inputs), e.compute(Da("AveragePool", e.inputs[0], !1, t));
			}, Ua = {
				autoPad: "",
				ceilMode: 0,
				countIncludePad: !1,
				...
				mn(e.inputs), e.compute(Da("GlobalAveragePool", e.inputs[0], !0, t));
			}, Na = (e, t, n, r) => {
				let [o, i] = Ea(t, r, n), s = `
      value = max(x_val, value);
    `, a = "", u = S("x", t.dataType, t.dims.length), d = ["rank"], [l, c, p, f, m] = ka(i, o);
				return l.push(...P(t.dims, i)), {
					name: e,
					shaderCache: {
						hint: `${r.cacheKey};${p};${f};${m}`,
						inputDependencies: d
					...
					getShaderSource: (h) => Pa(h, u, t.dims.length, i.length, o, s, a, t.dataType === 10 ? -65504 : -1e5, c, p, f, m)
				};
			}, La = (e, t) => {
				mn(e.inputs), e.compute(Na("MaxPool", e.inputs[0], !1, t));
			}, Wa = (e) => {
				...
				mn(e.inputs), e.compute(Na("GlobalMaxPool", e.inputs[0], !0, t));
			};
		});
      ...
      ${$.setByOffset("global_idx", `${$.type.value}(x_value - zero_point_value) * scale_value`)};
		...
		var Pc, zc, Za, Qa = k(() => {
			...
			Pc = (e, t, n) => {
				...
				let o = Math.abs(Math.ceil((t - e) / n)), i = [o], s = o, a = [
					{
						type: 12,
						data: s
					},
					...
					let l = C("output", r, i.length), c = l.type.value, p = [
						{
							name: "outputSize",
							type: "u32"
						},
			...
			Bc = (e, t, n, r) => {
              ...
              ${o}bitcast<${r}>(oldValue) + (${n})${i}`;
                ...
                ${o}max(bitcast<f32>(oldValue), (${n}))${i}`;
					case "min": return r === "i32" || r === "u32" ? `atomicMin(&${t}, bitcast<${r}>(${n}));` : `${o}min(bitcast<${r}>(oldValue), (${n}))${i}`;
					case "mul": return `${o}(bitcast<${r}>(oldValue) * (${n}))${i}`;
					default: throw new Error(`Reduction ${e} is not supported.`);
				}
			}, Dc = (e, t) => {
				let n = e[0].dims, r = e[1].dims, o = n, i = 1, s = Math.ceil(x.sizeToDimension(r, r.length - 1) / i), a = r[r.length - 1], u = x.sizeFromDimension(n, a), d = [
					{
						type: 12,
						data: s
					},
        ...
        `;
				...
				let r = (() => {
					switch (n.keepAspectRatioPolicy) {
						case "not_larger": return n.axes.length > 0 ? Math.min(...n.axes.map((i) => t[i]), Number.MAX_VALUE) : Math.min(...t, Number.MAX_VALUE);
						case "not_smaller": return n.axes.length > 0 ? Math.max(...n.axes.map((i) => t[i]), Number.MIN_VALUE) : Math.max(...t, Number.MIN_VALUE);
...
` : "", qc = (e, t, n, r, o) => {
    ...
    fn bilinearInterpolation(output_indices: ${t.type.indices}) -> ${l} {
      ...
      return (x11 * dx2 * dy2 + x12 * dx2 * dy1 + x21 * dx1 * dy2 + x22 * dx1 * dy1);
				...
				let [p, f] = n.length === 2 ? [0, 1] : [2, 3], m = e.type.value, h = (_) => {
					let y = _ === p ? "row" : "col";
					return `
...
`}
		...
		var Xc, Yc, iu, su = k(() => {
			...
			Xc = (e) => {
				...
				let o = t.simplified, i = e[0].dims, s = x.size(i), a = i, u = s, d = i.slice(-1)[0], l = r ? i.slice(0, -1).concat(1) : [], c = !o && e.length > 3, p = e.length > 4, f = r && n > 1, m = r && n > 2, h = n > 3, _ = 64, y = J(d), g = [
					{
						type: 12,
						data: u
					},
        ...
        for (var i: u32 = 0; i < stride; i++) {
          output[offset + i] = (output[offset + i] ${o ? "" : `- ${I}(mean)`}) *
            ...
            ${c ? "+ beta[offset1d + i]" : ""};
				...
				Xc(e.inputs);
				let r = [0];
				e.outputCount > 1 && r.push(-3), e.outputCount > 2 && r.push(-3), e.outputCount > 3 && r.push(3), e.compute(Yc(e.inputs, t, e.outputCount, !1), { outputs: r });
			};
		});
		var Jc, fn, ep, au, tp, np, uu, du, lu = k(() => {
			...
			Jc = (e, t) => {
				...
				if (e.length > 1) {
					...
					return o.length === 0 && (o = [...Array(e[0].dims.length).keys()]), L({
						starts: n,
						ends: r,
						axes: o
					});
          ...
          return input_indices;
				...
				i.forEach((y, g, b) => {
					if (y < 0) {
						let w = (a[g] - s[g]) / y, v = s[g];
						s[g] = v + w * i[g], a[g] = v, b[g] = -y;
					}
				});
				let d = n.slice(0);
				o.forEach((y, g) => {
				...
				let l = {
					dims: d,
					dataType: e[0].dataType
				}, c = C("output", e[0].dataType, d.length), p = S("input", e[0].dataType, e[0].dims.length), f = x.size(d), m = [
					{
						name: "outputSize",
						type: "u32"
					},
      ...
      ${y.registerUniforms(m).declareVariables(p, c)}
		...
		var rp, op, cu, pu, mu = k(() => {
			...
			rp = (e) => {
				...
				a ? (d = Array.from({ length: i }, (T, I) => I), d[s] = i - 1, d[i - 1] = s, u = e.compute(me(n, d), {
					inputs: [n],
					outputs: [-1]
				})[0]) : u = n;
      ...
      ${u.setByOffset("global_idx", a.getByIndices("input_indices"))}
        ...
        ${d}
				...
				if (i) {
					let d = ze.calcShape(ze.calcShape(t, n, !1), r, !1);
		...
		var _u, wu = k(() => {
			...
			_u = new Map([
				...
				["FusedConv", [rr, nr]],
				["Gather", [Fs, Hs]],
				["GatherElements", [ea, Js]],
				["GatherBlockQuantized", [Qs, Xs]],
				["GatherND", [Ks, js]],
				["Gelu", [xi]],
				["Gemm", [ra, na]],
				["GlobalAveragePool", [Va, Ra]],
				["GlobalMaxPool", [Ha, Ga]],
				["Greater", [Xi]],
				["GreaterOrEqual", [Ji]],
				["GridSample", [ia, sa]],
				["GroupQueryAttention", [ha]],
				["HardSigmoid", [Pi, ki]],
				["InstanceNormalization", [ba]],
				["LayerNormalization", [wa]],
				["LeakyRelu", [Si, bt]],
				["Less", [Yi]],
				["LessOrEqual", [es]],
				["Log", [Ni]],
		...
		var hn, $u = k(() => {
			...
			hn = class {
				...
				run(t, n, r, o, i) {
					...
					let u = [];
					for (let l of n) u.push({
						binding: u.length,
						resource: { buffer: l.buffer }
					});
					for (let l of r) u.push({
						binding: u.length,
						resource: { buffer: l.buffer }
					});
					i && u.push({
...
${a}`, d = r.createShaderModule({
			...
			lp = (e, t) => {
				...
				run(t, n, r, o, i, s) {
					...
					if (l) {
						...
						this.device.queue.writeBuffer(T.buffer, 0, $, 0, b), this.gpuDataManager.release(T.id), m = {
							offset: 0,
							size: b,
							buffer: T.buffer
						};
			...
			vt = class e {
				...
				if (e === "webgpu") {
					...
					await s.initialize(n, r), o("webgpu", [
						...
						(a, u, d) => s.createKernel(a, Number(u), d, t.UTF8ToString(t._JsepGetNodeName(Number(u)))),
						(a) => s.releaseKernel(a),
						(a, u, d, l) => {
			...
			mp = (e, t) => {
				...
				try {
					...
					for (let w of t?.executionProviders ?? []) if ((typeof w == "string" ? w : w.name) === "webnn") {
						if (o.shouldTransferToMLTensor = !1, typeof w != "string") {
							...
							T ? o.currentContext = T : I ? o.currentContext = await o.webnnCreateMLContext(I) : o.currentContext = await o.webnnCreateMLContext({
								deviceType: E,
								powerPreference: z
							});
					...
					i = await o._OrtCreateSession(n, r, s), o.webgpuOnCreateSession?.(i), i === 0 && Y("Can't create a session."), o.jsepOnCreateSession?.(), o.currentContext && (o.webnnRegisterMLContext(i, o.currentContext), o.currentContext = void 0, o.shouldTransferToMLTensor = !0);
					...
					let b = null;
					return g.some((w) => w === "gpu-buffer" || w === "ml-tensor" || w === "ml-tensor-cpu-output") && (a = o._OrtCreateBinding(i), a === 0 && Y("Can't create IO binding."), b = {
						handle: a,
						outputPreferredLocations: g,
						outputPreferredLocationsEncoded: g.map((w) => w === "ml-tensor-cpu-output" ? "ml-tensor" : w).map((w) => Bn(w))
					}), tt.set(i, [
						i,
						d,
						l,
				...
				try {
					...
					if (p && !m) {
						...
						Ve("wasm bindInputsOutputs"), tt.set(e, [
							d,
							l,
							c,
							p,
					...
					for (let U = 0; U < _; U++) {
						...
						let G = s.stackSave(), V = s.stackAlloc(4 * a), j = !1, Q, X = 0;
						try {
							...
							if (Q === "string") {
								...
								for (let de = 0; de < ae; de++) {
									let We = s.getValue(X + de * a, "*"), St = s.getValue(X + (de + 1) * a, "*"), yr = de === ae - 1 ? void 0 : St - We;
								...
								if (We === void 0 || !Lt(Q)) throw new Error(`Unsupported data type: ${Q}`);
								j = !0, W.push([
									Q,
									he,
									{
										gpuBuffer: de,
										download: s.jsepCreateDownloader(de, We, Q),
										dispose: () => {
								...
								if (!de(e, Q, !1)) throw new Error(`preferredLocation "ml-tensor" for ${Q} output is not supported by current WebNN Context.`);
								let St = await ie(e, X, A, he, !1);
								j = !0, W.push([
									Q,
									he,
									{
										mlTensor: St,
										download: s.webnnCreateMLTensorDownloader(X, Q),
										dispose: () => {
								...
								let de = new (it(Q))(ae);
								new Uint8Array(de.buffer, de.byteOffset, de.byteLength).set(s.HEAPU8.subarray(X, X + de.byteLength)), W.push([
									Q,
									he,
									de,
									"cpu"
					...
					p && !f && (s._OrtClearBoundOutputs(p.handle) !== 0 && Y("Can't clear bound outputs."), tt.set(e, [
						d,
						l,
						c,
						p,
		...
		var nt, Se, xt, yn, bn, gn, fr, hr, dt, lt, gp, Au, Eu, ku, Pu, zu, Bu, Du, gr = k(() => {
			...
			He();
			Et();
			nt = () => !!te.wasm.proxy && typeof document < "u", xt = !1, yn = !1, bn = !1, hr = /* @__PURE__ */ new Map(), dt = (e, t) => {
				let n = hr.get(e);
				n ? n.push(t) : hr.set(e, [t]);
			}, lt = () => {
				if (xt || !yn || bn || !Se) throw new Error("worker not ready");
			}, gp = (e) => {
				switch (e.data.type) {
					case "init-wasm":
						xt = !1, e.data.err ? (bn = !0, fr[1](e.data.err)) : (yn = !0, fr[0]()), gn && (URL.revokeObjectURL(gn), gn = void 0);
						break;
					case "init-ep":
					case "copy-from":
					case "create":
				...
				if (!yn) {
					if (xt) throw new Error("multiple calls to 'initWasm()' detected.");
					if (bn) throw new Error("previous call to 'initWasm()' failed.");
					if (xt = !0, nt()) return new Promise((e, t) => {
					...
					try {
						await kt(te.wasm), await Pt(te), yn = !0;
					} catch (e) {
						throw bn = !0, e;
					} finally {
						xt = !1;
				...
				if (nt()) return lt(), new Promise((t, n) => {
					dt("init-ep", [t, n]);
					let r = {
						type: "init-ep",
						in: {
		...
		var Ru = {};
		rt(Ru, {
			OnnxruntimeWebAssemblyBackend: () => wn,
			initializeFlags: () => Uu,
			wasmBackend: () => bp
		});
		var Uu, wn, bp, Vu = k(() => {
		...
		Object.defineProperty(te.versions, "web", {
			value: Kr,
			enumerable: !0
		});
		return ct(wp);
...
//#endregion
//#region node_modules/@ricky0123/vad-web/dist/models/common.js
var require_common = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
}));
//#endregion
//#region node_modules/@ricky0123/vad-web/dist/models/legacy.js
var require_legacy = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var SileroLegacy = class {
		constructor(ortInstance, _session, _h, _c, _sr) {
			...
			this._sr = _sr;
			this.reset_state = () => {
				const zeroes = Array(128).fill(0);
				this._h = new this.ortInstance.Tensor("float32", zeroes, [
					2,
					1,
					64
				]);
				this._c = new this.ortInstance.Tensor("float32", zeroes, [
					2,
					1,
					64
				]);
			...
			this.process = async (audioFrame) => {
				const inputs = {
					input: new this.ortInstance.Tensor("float32", audioFrame, [1, audioFrame.length]),
					h: this._h,
					c: this._c,
					sr: this._sr
				};
	...
	SileroLegacy.new = async (ortInstance, modelFetcher) => {
		...
		const zeroes = Array(128).fill(0);
		const _h = new ortInstance.Tensor("float32", zeroes, [
			2,
			1,
			64
		]);
		const _c = new ortInstance.Tensor("float32", zeroes, [
			2,
			1,
			64
		]);
		logging_1.log.debug("vad is initialized");
		return new _a(ortInstance, _session, _h, _c, _sr);
	};
}));
//#endregion
//#region node_modules/@ricky0123/vad-web/dist/models/v5.js
var require_v5 = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	function getNewState(ortInstance) {
		const zeroes = Array(256).fill(0);
		return new ortInstance.Tensor("float32", zeroes, [
			2,
			1,
			128
		]);
	...
	var SileroV5 = class {
		constructor(_session, _state, _sr, ortInstance) {
			...
			this.process = async (audioFrame) => {
				...
				const out = await this._session.run(inputs);
				if (!out["stateN"]) throw new Error("No state from model");
				this._state = out["stateN"];
				if (!out["output"]?.data) throw new Error("No output from model");
				const isSpeech = out["output"].data[0];
				if (typeof isSpeech != "number") throw new Error("Weird output data");
				return {
					notSpeech: 1 - isSpeech,
					isSpeech
				};
...
//#endregion
//#region node_modules/@ricky0123/vad-web/dist/models/index.js
var require_models = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	Object.defineProperty(exports, "SileroLegacy", {
		enumerable: true,
		get: function() {
	...
	var v5_1 = require_v5();
	Object.defineProperty(exports, "SileroV5", {
		enumerable: true,
		get: function() {
...
//#endregion
//#region node_modules/@ricky0123/vad-web/dist/resampler.js
var require_resampler = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	...
	var Resampler = class {
		constructor(options) {
			...
			if (options.nativeSampleRate < 16e3) logging_1.log.error("nativeSampleRate is too low. Should have 16000 = targetSampleRate <= nativeSampleRate");
			this.inputBuffer = [];
		}
		async *stream(audioInput) {
			for (const sample of audioInput) {
				this.inputBuffer.push(sample);
				while (this.hasEnoughDataForFrame()) yield this.generateOutputFrame();
			}
		}
...
//#endregion
//#region node_modules/@ricky0123/vad-web/dist/non-real-time-vad.js
var require_non_real_time_vad = /* @__PURE__ */ __commonJSMin(((exports) => {
	var __createBinding = exports && exports.__createBinding || (Object.create ? (function(o, m, k, k2) {
		if (k2 === void 0) k2 = k;
		var desc = Object.getOwnPropertyDescriptor(m, k);
		if (!desc || ("get" in desc ? !m.__esModule : desc.writable || desc.configurable)) desc = {
	...
	var NonRealTimeVAD = class {
		static async new(options = {}) {
			...
			if (fullOptions.ortConfig !== void 0) fullOptions.ortConfig(ortInstance);
			...
			return new this(modelFetcher, ortInstance, fullOptions, frameProcessor);
		}
		...
		async *run(inputAudio, sampleRate) {
			...
			for await (const frame of resampler.stream(inputAudio)) {
				...
				for (const event of messageContainer) switch (event.msg) {
			...
			for (const event of messageContainer) switch (event.msg) {
				case messages_1.Message.SpeechEnd: yield {
					audio: event.audio,
					start,
...
//#endregion
//#region node_modules/@ricky0123/vad-web/dist/utils.js
var require_utils = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	async function audioFileToArray(audioFileData) {
		...
		if (audioBuffer === null) throw Error("some shit");
		const _audioBuffer = audioBuffer;
		const out = new Float32Array(_audioBuffer.length);
		for (let i = 0; i < _audioBuffer.length; i++) for (let j = 0; j < _audioBuffer.numberOfChannels; j++) {
			const sample = _audioBuffer.getChannelData(j)[i];
			const current = out[i];
			if (sample === void 0 || current === void 0) throw new Error("sample or out[i] is undefined");
			out[i] = current + sample;
		}
		return {
			audio: out,
			sampleRate: _audioBuffer.sampleRate
		};
	}
	exports.audioFileToArray = audioFileToArray;
}));
//#endregion
//#region node_modules/onnxruntime-web/dist/ort.wasm.min.js
/*!
* ONNX Runtime Web v1.26.0
* Copyright (c) Microsoft Corporation. All rights reserved.
* Licensed under the MIT License.
*/
var require_ort_wasm_min = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var ort = (() => {
		...
		var Se = (e, t) => {
			...
			if (t && typeof t == "object" || typeof t == "function") for (let r of Ln(t)) !Pn.call(e, r) && r !== n && Je(e, r, {
				get: () => t[r],
				enumerable: !(o = Bn(t, r)) || o.enumerable
			});
			return e;
		};
		var Ye = (e) => _n(Je({}, "__esModule", { value: !0 }), e);
		var Te, K, se, Dn, bt, Ze = E(() => {
			"use strict";
			Te = /* @__PURE__ */ new Map(), K = [], se = (e, t, n) => {
				if (t && typeof t.init == "function" && typeof t.createInferenceSessionHandler == "function") {
					let o = Te.get(e);
					if (o === void 0) Te.set(e, {
						backend: t,
						priority: n
					});
					else {
			...
			It = (e, t) => {
				...
				if (o != null) {
					...
					a === void 0 || a.mean === void 0 ? u = [
						...
						a.mean[2],
						0
					], a.mean[3] !== void 0 && (u[3] = a.mean[3])), a === void 0 || a.bias === void 0 ? f = [
						0,
						0,
						0,
						0
					] : typeof a.bias == "number" ? f = [
						a.bias,
						a.bias,
						a.bias,
						a.bias
				...
				if (n != null) {
					...
					u === void 0 || u.mean === void 0 ? f = [
						255,
						255,
						255,
						255
					] : typeof u.mean == "number" ? f = [
						u.mean,
						u.mean,
						u.mean,
						u.mean
						...
						u.mean[2],
						255
					], u.mean[3] !== void 0 && (f[3] = u.mean[3])), u === void 0 || u.bias === void 0 ? l = [
						0,
						0,
						0,
						0
		...
		var Ke, Bt, Lt, Pt, _t, Dt, Ut = E(() => {
			...
			Ke = (e, t) => {
				...
				if (t.height === void 0 || t.width === void 0) throw new Error("Image height and width must be defined");
				if (t.tensorLayout === "NHWC") throw new Error("NHWC Tensor layout is not supported yet");
				let { height: n, width: o } = t, r = t.norm ?? {
					mean: 255,
					bias: 0
				}, i, s;
				typeof r.mean == "number" ? i = [
					r.mean,
					r.mean,
					r.mean,
					r.mean
		...
		var Mt, Rt, Ft = E(() => {
			...
			Mt = (e) => {
				...
				switch (e.location) {
					case "cpu": return new x(e.type, e.data, t);
					case "cpu-pinned": return new x({
						location: "cpu-pinned",
						data: e.data,
						type: e.type,
						dims: t
					});
					case "texture": return new x({
						location: "texture",
						texture: e.texture,
						type: e.type,
						dims: t
					});
					case "gpu-buffer": return new x({
						location: "gpu-buffer",
						gpuBuffer: e.gpuBuffer,
						type: e.type,
						dims: t
					});
					case "ml-tensor": return new x({
						location: "ml-tensor",
						mlTensor: e.mlTensor,
						type: e.type,
						dims: t
				...
				async run(t, n, o) {
					...
					if (typeof n == "object") {
						...
						if (Array.isArray(n)) {
							...
							let f = !1, l = Object.getOwnPropertyNames(n);
							for (let c of this.outputNames) if (l.indexOf(c) !== -1) {
								let d = n[c];
		...
		var st, it, Re, nn, Fn, Nn, kn, Le, I, ee = E(() => {
			...
			it = !1, Re = !1, nn = !1, Fn = () => {
				...
				let r = e.wasmPaths, i = typeof r == "string" ? r : void 0, s = r?.mjs, a = s?.href ?? s, u = r?.wasm, f = u?.href ?? u, l = e.wasmBinary, [c, d] = await tn(a, i, n > 1, !!l || !!f), p = !1, h = [];
				if (t > 0 && h.push(new Promise((y) => {
					...
					d(m).then((w) => {
						Re = !1, it = !0, st = w, y(), c && URL.revokeObjectURL(c);
					}, (w) => {
						Re = !1, nn = !0, O(w);
					});
		...
		var ae, Ne, ue, un, fn, ke, We, cn, at = E(() => {
			...
			ae = (e) => {
				...
				let n = [
					...
					.5,
					.5
				][e], o = typeof t == "number" ? t : t.reduce((r, i) => r * i, 1);
		...
		var Hn, Pe, _e, fe, jn, dn, we, De, Ue, ln, xe, ve, Ce, rt = E(() => {
			...
			Hn = (e, t) => {
				...
				try {
					...
					for (let g of t?.executionProviders ?? []) if ((typeof g == "string" ? g : g.name) === "webnn") {
						if (r.shouldTransferToMLTensor = !1, typeof g != "string") {
							...
							M ? r.currentContext = M : v ? r.currentContext = await r.webnnCreateMLContext(v) : r.currentContext = await r.webnnCreateMLContext({
								deviceType: le,
								powerPreference: re
							});
					...
					i = await r._OrtCreateSession(n, o, s), r.webgpuOnCreateSession?.(i), i === 0 && S("Can't create a session."), r.jsepOnCreateSession?.(), r.currentContext && (r.webnnRegisterMLContext(i, r.currentContext), r.currentContext = void 0, r.shouldTransferToMLTensor = !0);
					let [c, d] = jn(i), p = !!t?.enableGraphCapture, h = [], y = [], O = [], m = [];
					for (let g = 0; g < c; g++) {
						let [T, U, M] = dn(i, g);
				...
				if (!u) throw new Error(`cannot run inference. invalid session id: ${e}`);
				let f = u[0], l = u[1], c = u[2], d = u[3], p = u[4];
				u[5];
				let y = t.length, O = o.length, m = 0, w = [], B = [], g = [], T = [], U = [], M = s.stackSave(), v = s.stackAlloc(y * a), le = s.stackAlloc(y * a), re = s.stackAlloc(O * a), lt = s.stackAlloc(O * a);
				try {
					...
					for (let b = 0; b < y; b++) s.setValue(v + b * a, B[b], "*"), s.setValue(le + b * a, l[t[b]], "*");
					...
					for (let b = 0; b < O; b++) {
						...
						let mt = s.stackSave(), $ = s.stackAlloc(4 * a), oe = !1, P, C = 0;
						try {
							...
							for (let D = 0; D < On; D++) H.push(Number(s.getValue(wt + D * a, Ve)));
							...
							if (P === "string") {
								...
								if (!L(e, P, !1)) throw new Error(`preferredLocation "ml-tensor" for ${P} output is not supported by current WebNN Context.`);
								let Ee = await D(e, C, ge, H, !1);
								oe = !0, z.push([
									P,
									H,
									{
								...
								let L = new (un(P))(j);
								new Uint8Array(L.buffer, L.byteOffset, L.byteLength).set(s.HEAPU8.subarray(C, C + L.byteLength)), z.push([
									P,
									H,
									L,
									"cpu"
					...
					d && !p && (s._OrtClearBoundOutputs(d.handle) !== 0 && S("Can't clear bound outputs."), fe.set(e, [
						f,
						l,
						c,
						d,
		...
		var ne, W, ye, $e, ze, Ge, ft, ct, ce, de, Jn, pn, mn, wn, hn, bn, yn, gn, dt = E(() => {
			...
			ee();
			Be();
			ne = () => !!A.wasm.proxy && typeof document < "u", ye = !1, $e = !1, ze = !1, ct = /* @__PURE__ */ new Map(), ce = (e, t) => {
				let n = ct.get(e);
				...
				switch (e.data.type) {
					case "init-wasm":
						ye = !1, e.data.err ? (ze = !0, ft[1](e.data.err)) : ($e = !0, ft[0]()), Ge && (URL.revokeObjectURL(Ge), Ge = void 0);
						break;
					case "init-ep":
					case "copy-from":
					case "create":
				...
				if (!$e) {
					...
					if (ye = !0, ne()) return new Promise((e, t) => {
					...
					try {
						await Le(A.wasm), await Pe(A), $e = !0;
					} catch (e) {
						throw ze = !0, e;
					} finally {
						ye = !1;
		...
		var Tn, je, Yn, An = E(() => {
			...
			Tn = () => {
				...
				let e = A.wasm.simd;
				if (typeof e != "boolean" && e !== void 0 && e !== "fixed" && e !== "relaxed" && (console.warn(`Property "env.wasm.simd" is set to unknown value "${e}". Reset it to \`false\` and ignore SIMD feature checking.`), A.wasm.simd = !1), typeof A.wasm.proxy != "boolean" && (A.wasm.proxy = !1), typeof A.wasm.trace != "boolean" && (A.wasm.trace = !1), typeof A.wasm.numThreads != "number" || !Number.isInteger(A.wasm.numThreads) || A.wasm.numThreads <= 0) if (typeof self < "u" && !self.crossOriginIsolated) A.wasm.numThreads = 1;
				else {
		...
		Object.defineProperty(A.versions, "web", {
			value: Vt,
			enumerable: !0
		});
		return Ye(Xn);
...
//#endregion
//#region node_modules/@ricky0123/vad-web/dist/real-time-vad.js
var require_real_time_vad = /* @__PURE__ */ __commonJSMin(((exports) => {
	var __createBinding = exports && exports.__createBinding || (Object.create ? (function(o, m, k, k2) {
		if (k2 === void 0) k2 = k;
		var desc = Object.getOwnPropertyDescriptor(m, k);
		if (!desc || ("get" in desc ? !m.__esModule : desc.writable || desc.configurable)) desc = {
	...
	var detectProcessorType = (ctx) => {
		if ("audioWorklet" in ctx && typeof AudioWorkletNode === "function") return "AudioWorklet";
		...
		audioNode.port.onmessage = async (ev) => {
			...
			switch (data.message) {
				case messages_1.Message.AudioFrame:
					...
					await processFrame(new Float32Array(data.data));
					break;
			}
		};
		return audioNode;
	...
	exports.MicVAD = class MicVAD {
		constructor(options, frameProcessor, model, frameSamples, listening = false, errored = null, _stream = null, _audioContext = null, _vadNode = null, _mediaStreamAudioSourceNode = null, _audioProcessorAdapterType = null, initializationState = "uninitialized", ownsAudioContext = false) {
			...
			this.getAudioInstances = () => {
				if (this._stream === null || this._audioContext === null || this._vadNode == null || this._mediaStreamAudioSourceNode == null) throw new Error("MicVAD has null stream, audio context, or processor adapter");
				return {
					stream: this._stream,
				...
				switch (this.initializationState) {
					case "uninitialized":
						...
						try {
							...
							if (error instanceof Error) this.setErrored(error.message);
							else this.setErrored(String(error));
							throw error;
						}
						...
						switch (this._audioProcessorAdapterType) {
							...
							case "ScriptProcessor":
								...
								break;
							default: throw new Error(`Unsupported audio processor adapter type: ${this._audioProcessorAdapterType}`);
						}
						this._mediaStreamAudioSourceNode = new MediaStreamAudioSourceNode(this._audioContext, { mediaStream: this._stream });
			...
			this.destroy = async () => {
				...
				if (vadNode instanceof AudioWorkletNode) vadNode.port.postMessage(messages_1.Message.SpeechStop);
				if (this.listening) await this.pause();
				await this.model.release();
				if (this.ownsAudioContext) await this._audioContext?.close();
			};
			this.setOptions = (update) => {
		...
		static async new(options = {}) {
			...
			if (fullOptions.ortConfig !== void 0) fullOptions.ortConfig(exports.ort);
			...
			const micVad = new MicVAD(fullOptions, new frame_processor_1.FrameProcessor(model.process, model.reset_state, {
				positiveSpeechThreshold: fullOptions.positiveSpeechThreshold,
				negativeSpeechThreshold: fullOptions.negativeSpeechThreshold,
				redemptionMs: fullOptions.redemptionMs,
				preSpeechPadMs: fullOptions.preSpeechPadMs,
				minSpeechMs: fullOptions.minSpeechMs,
				submitUserSpeechOnPause: fullOptions.submitUserSpeechOnPause
			}, msPerFrame), model, frameSamples);
			if (fullOptions.startOnLoad) try {
				await micVad.start();
			} catch (e) {
...
//#endregion
//#region node_modules/@ricky0123/vad-web/dist/index.js
var require_dist = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var asset_path_1 = require_asset_path();
	Object.defineProperty(exports, "baseAssetPath", {
		enumerable: true,
		get: function() {
	...
	var default_model_fetcher_1 = require_default_model_fetcher();
	Object.defineProperty(exports, "defaultModelFetcher", {
		enumerable: true,
		get: function() {
	...
	var frame_processor_1 = require_frame_processor();
	Object.defineProperty(exports, "FrameProcessor", {
		enumerable: true,
		get: function() {
	...
	Object.defineProperty(exports, "NonRealTimeVAD", {
		enumerable: true,
		get: function() {
	...
	Object.defineProperty(exports, "MicVAD", {
		enumerable: true,
		get: function() {
			return real_time_vad_1.MicVAD;
		}
	});
	Object.defineProperty(exports, "getDefaultRealTimeVADOptions", {
		enumerable: true,
		get: function() {
