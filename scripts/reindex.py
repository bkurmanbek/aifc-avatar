"""
scripts/reindex.py — Rebuild the Qdrant vector index for AIFC RAG using BAAI/bge-m3.
...
Usage (from project root):
    ...
    python scripts/reindex.py --chunks data/chunks/chunks.json
    python scripts/reindex.py --chunks data/chunks/chunks_afsa-web.json data/chunks/chunks_aix-web.json
    python scripts/reindex.py --batch-size 32 --verbose
"""
