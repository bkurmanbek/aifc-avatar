"""
scripts/processing/chunk.py — AIFC voice agent RAG chunker.
...
Usage (from project root):
  python scripts/processing/chunk.py              # chunk all files
  python scripts/processing/chunk.py --stats      # print stats only (no write)
  python scripts/processing/chunk.py --file <md>  # chunk a single markdown file
"""
