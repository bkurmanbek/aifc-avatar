...
env \
  ...
  SYNCTALK_DTYPE="${SYNCTALK_DTYPE:-fp32}" \
  SYNCTALK_PIPELINE="${SYNCTALK_PIPELINE:-1}" \
  SYNCTALK_FAST_COMPOSITE="${SYNCTALK_FAST_COMPOSITE:-0}" \
  SYNCTALK_GPU_JPEG="${SYNCTALK_GPU_JPEG:-0}" \
  SYNCTALK_JPEG_QUALITY="${SYNCTALK_JPEG_QUALITY:-82}" \
