...
def configure_logging(*, reset: bool = False) -> None:
    ...
    module_filters: dict[str, tuple[str, ...]] = {
        "stt": ("backend.stt", "backend.legacy.stt"),
        "llm": ("backend.llm", "backend.legacy.llm", "backend.legacy.answer_race"),
        "tts": ("backend.tts", "backend.legacy.tts", "backend.legacy.soniox_tts"),
        "avatar": ("backend.avatar", "backend.legacy.synctalk"),
        "pipeline": ("backend.pipeline", "backend.legacy.response_stream", "backend.legacy.app"),
        "websocket": ("backend.websocket", "backend.legacy.ws_writer"),
    }
