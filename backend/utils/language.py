...
GOODBYE = {
    "en": {"bye": "Goodbye. I will be here if you have more questions about AIFC.",
           "goodbye": "Goodbye. I will be here if you have more questions about AIFC."},
    "ru": {"пока": "До свидания. Я буду рад помочь, если появятся новые вопросы о МФЦА.",
           "до свидания": "До свидания. Я буду рад помочь, если появятся новые вопросы о МФЦА."},
    "kk": {"сау бол": "Сау болыңыз. АХҚО бойынша тағы сұрақтарыңыз болса, көмектесуге дайынмын.",
           "сау болыңыз": "Сау болыңыз. АХҚО бойынша тағы сұрақтарыңыз болса, көмектесуге дайынмын."},
    "zh": {"拜拜": "再见。如果之后您有 AIFC 相关问题，我可以继续帮助您。",
           "再见": "再见。如果之后您有 AIFC 相关问题，我可以继续帮助您。"},
}
